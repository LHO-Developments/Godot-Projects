...
func setup_level(ln: String, raw_level_data: Dictionary) -> LevelLayout:
	...
	var raw_titles: Dictionary = raw_level_data.tiles;
	var player_start: Dictionary = raw_level_data.player_start;
	
	add_tiles_for_layer(layout, TileLayers.LayerType.Floor, raw_titles.Floor);
	add_tiles_for_layer(layout, TileLayers.LayerType.Walls, raw_titles.Walls);
	add_tiles_for_layer(layout, TileLayers.LayerType.Boxes, raw_titles.Boxes);
	add_tiles_for_layer(layout, TileLayers.LayerType.TargetBoxes, raw_titles.TargetBoxes);
	add_tiles_for_layer(layout, TileLayers.LayerType.Targets, raw_titles.Targets);
